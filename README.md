...
| nri_population                   | Numerical |  Population in each census tract                                                                                                       |
| nri_build_value                  | Numerical |   Estimated building value in each census tract                                                                                                                           |
| nri_agri_value                   | Numerical |   Estimated agriculture value in each census tract                                                                                                                |
| nri_area                         | Numerical |  Census Tract Area in square meter, from original nri dataset                                                                                                                     |   
...
| nri_intpt_lat                    | Numerical |   Estimated latitude of where each census tract is centered                                                                                                  | 
| nri_intpt_long                   | Numerical |  Estimated longitude of where each census tract is centered                                                                                            | 
| nri_zipcode                      | Categorical |  Zipcode of which each census tract belongs to                                                                                                   |   
| census_tract_area                |   Numerical |  Census Tract Area in square meter, calculated directly from boundary shapefiles                                                                                                                              | 
| census_tract_category            | Categorical |   whether the census tract is labeled as 'urban', 'suburban', or 'rural' by our own definition                                                                                                       |
